...
<div class="main-list">
  <div class="lbtit"><span>热门礼包</span></div>
  <ul class="lblist">
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from www_96kaifa_com_ecms_libao where isgood=1 order by newstime desc limit 2",6,24,0);
if($ecms_bq_sql){
...
<?php $cpl=round(($bqr[yiling]/$bqr[zongshu]),2)*100; $ss=100-$cpl; ?>
	...
	<li> <a href="<?=$bqsr['titleurl']?>" class="gxian"> <img src="<?=$public_r['add_www_96kaifa_com_url']?><?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>">
        ...
        </a> <a href="<?=$bqsr['titleurl']?>" class="btn_lq">领取</a> </li>
<?php
}
}
?>
  </ul>
  <div class="lbtit"><span>最新礼包</span></div>
  <div id="newopen">
    <ul class="lblist" id="article_js_list">
[!--empirenews.listtemp--]
<!--list.var1-->
[!--empirenews.listtemp--]
    </ul>
...
<?php 
$num=$empire->gettotal("select count(*) as total from www_96kaifa_com_ecms_libao");
$zongshu= $num - 20;
