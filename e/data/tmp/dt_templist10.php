...
$num=$empire->gettotal("select count(*) as total from www_96kaifa_com_ecms_game where fenlei='$fenlid'");
}
$zongshu= $num - 30;
...
$(function(){
    ...
    $('#loadmore').on('click',function(){
		if(is_have_con=="Y"){
			$.ajax({
				url : '/96kaifa/game-j-getajax.php',
				type:'get',
...
<script type="text/javascript" src="/96kaifa/statics/wap_v1/js/orderby.js"></script>
