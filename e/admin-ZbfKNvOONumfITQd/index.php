    ...
    <tr> 
      ...
      <td width="157" rowspan="2" valign="top" bgcolor="#FFFFFF"> 
        <table width="157" height="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="100%" valign="bottom"> <div align="right"><a href="../../" target="_blank"><img src="loginimg/homepage.gif" width="79" height="21" border="0"></a>&nbsp;<a href="http://www.96kaifa.com" target="_blank"><img src="loginimg/empirebbs.gif" width="69" height="21" border="0"></a></div></td>
          </tr>
        </table> </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="73%" height="30">Powered by <a href="http://www.phome.net" target="_blank"><strong>EmpireCMS</strong></a> 
              <font color="#FF9900"><strong>7.5</strong></font> &copy; 2002-2018 <a href="https://www.96kaifa.com" target="_blank">96KaiFa源码</a> 
              Inc.</td>
            <td width="8%">&nbsp;</td>
          </tr>
        </table></td>
