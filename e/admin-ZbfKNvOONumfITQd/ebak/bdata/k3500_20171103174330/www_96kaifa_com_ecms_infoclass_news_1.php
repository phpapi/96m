...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_ecms_infoclass_news`;");
E_C("CREATE TABLE `www_96kaifa_com_ecms_infoclass_news` (
  ...
  `zz_xgname` text NOT NULL,
  `z_xgname` varchar(255) NOT NULL,
  `qz_xgname` varchar(255) NOT NULL,
  `save_xgname` varchar(10) NOT NULL,
