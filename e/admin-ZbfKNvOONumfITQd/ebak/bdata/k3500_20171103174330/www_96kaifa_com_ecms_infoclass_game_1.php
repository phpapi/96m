...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_ecms_infoclass_game`;");
E_C("CREATE TABLE `www_96kaifa_com_ecms_infoclass_game` (
  ...
  `zz_fenlei` text NOT NULL,
  `z_fenlei` varchar(255) NOT NULL,
  `qz_fenlei` varchar(255) NOT NULL,
  `save_fenlei` varchar(10) NOT NULL,
  `zz_yijuhua` text NOT NULL,
  `z_yijuhua` varchar(255) NOT NULL,
  `qz_yijuhua` varchar(255) NOT NULL,
  `save_yijuhua` varchar(10) NOT NULL,
  `zz_morepic` text NOT NULL,
  `z_morepic` varchar(255) NOT NULL,
  `qz_morepic` varchar(255) NOT NULL,
  `save_morepic` varchar(10) NOT NULL,
  `zz_h5url` text NOT NULL,
  `z_h5url` varchar(255) NOT NULL,
  `qz_h5url` varchar(255) NOT NULL,
  `save_h5url` varchar(10) NOT NULL,
  `zz_fmimg` text NOT NULL,
  `z_fmimg` varchar(255) NOT NULL,
  `qz_fmimg` varchar(255) NOT NULL,
  `save_fmimg` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
