...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_ecms_infoclass_danji`;");
E_C("CREATE TABLE `www_96kaifa_com_ecms_infoclass_danji` (
  ...
  `zz_yxurl` text NOT NULL,
  `z_yxurl` varchar(255) NOT NULL,
  `qz_yxurl` varchar(255) NOT NULL,
  `save_yxurl` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
