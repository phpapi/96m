...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_enewspublic_update`;");
E_C("CREATE TABLE `www_96kaifa_com_enewspublic_update` (
...
E_D("replace into `www_96kaifa_com_enewspublic_update` values('1','1355124469','1355124476','1467','0','|1,791|9,135|10,497|11,21|12,21|','','1509253563','1509253563','0','3','0','0');");
