...
E_D("DROP TABLE IF EXISTS `www_96kaifa_com_enewsuseradd`;");
E_C("CREATE TABLE `www_96kaifa_com_enewsuseradd` (
...
E_D("replace into `www_96kaifa_com_enewsuseradd` values('1','0','','','','0');");
