...
if($clasid96kaifa==0){
$aabbccdd = base64_encode("select * from www_96kaifa_com_ecms_game order by newstime desc limit");
}else{
$aabbccdd = base64_encode("select * from www_96kaifa_com_ecms_game where fenlei='$clasid96kaifa' order by newstime desc limit");
}
